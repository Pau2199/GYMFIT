<header class="container-fluid">
    <div class="row justify-content-md-between">
        ...
        <div class="col-md-6 d-md-block d-none search">
        ...
        <div class="d-none d-md-block col-md-2 mt-5">
            <img class="svgTamanyo mr-5" src="{{asset('img/user.svg')}}" alt="Control Usuario">
        ...
        <div class="d-block d-md-none col-12">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <img class="logoTipoMovil" src="{{asset('img/logo.png')}}" alt="">
                    </div>
                    <div class="col-6">
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="d-md-none d-block search">
        <form class="form-inline">
            <input class="form-control mr-sm-2 w-50" type="text" placeholder="Buscar producto" aria-label="Buscar">
